...
header('location:index.php');
    ...
    function sendTelegramMessage($chatId, $message, $botToken) {
        ...
        file_get_contents($url); // Using file_get_contents for simplicity. You might want to use curl for more robust handling.
    }
...
$rstatus=1;
        ...
        $sql = "SELECT s.telegram_chat_id, s.FullName, b.BookName, b.ISBNNumber,s.StudentId
    ...
    if ($result && $result->telegram_chat_id) {
        ...
        $studentId = $result->StudentId;
         ...
         // Construct the billing link (replace with your actual URL)
        ...
        $message = "Dear " . $studentName . ",\n" .
           ...
           if ($fine > 0) {
                $message .= "A fine of USD " . $fine . " has been applied.\n";
            } else {
             $message .= "No fine was charged.\n";
            }

            $message .= "You can use the login button below to check your account details";
